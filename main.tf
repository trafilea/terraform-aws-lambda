...
locals {
  ...
  source_code_hash  = var.var.s3_existing_package != null ? null : data.aws_lambda_function.existing[0].source_code_hash
...
resource "aws_lambda_function" "this" {
  ...
  source_code_hash = var.ignore_source_code_hash ? null : var.s3_existing_package == null ? local.source_code_hash : (local.filename == null ? false : fileexists(local.filename)) && !local.was_missing ? filebase64sha256(local.filename) : null
